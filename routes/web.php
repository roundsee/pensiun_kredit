...
//Route::get('/calculatesimulasi', [KbSimulationController::class, 'calculatesimulasi'])->name('calculatesimulasi');
Route::post('/calculatesimulasi', [KbSimulationController::class, 'calculatesimulasi'])->name('calculatesimulasi');
Route::post('/storesimulasi', [KbSimulationController::class, 'storesimulasi'])->name('storesimulasi');

Route::post('/downloadpdfsimulasi', [KbSimulationController::class, 'downloadPdfSImulasi'])->name('downloadpdfsimulasi');
...
Route::middleware(['auth', 'role:admin,supervisor,operation'])->group(function () {
    Route::get('/pam', [\App\Http\Controllers\ProductStructController::class, 'index'])->name('pam.index');
    Route::get('/pam/create', [\App\Http\Controllers\ProductStructController::class, 'create'])->name('pam.create');
    Route::post('/pam', [\App\Http\Controllers\ProductStructController::class, 'store'])->name('pam.store');
...
Route::get('/register', [UserManagementController::class, 'create'])->name('register')->middleware(['auth', 'role:admin,supervisor']);
Route::post('/register', [UserManagementController::class, 'store'])->name('register.store')->middleware(['auth', 'role:admin,supervisor']);
Route::post('/logout', [AuthController::class, 'logout'])->name('logout');

Route::get('/users/role-setting', [UserManagementController::class, 'index'])->name('users.role_setting')->middleware(['auth', 'role:admin,supervisor']);
Route::patch('/users/{user}/role', [UserManagementController::class, 'updateRole'])->name('users.update_role')->middleware(['auth', 'role:admin,supervisor']);
