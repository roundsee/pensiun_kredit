...
function kbSimulasiForm() {
    ...
    return {
        ...
        form: {
            ...
            angsuran_lainnya: '',
            blokir_angsuran: '1',
            rate_percent_override: 16, // Fixed default 16%
            admin_angsuran_percent_override: 10, // Fixed default 10%
            tenor: '',
            plafond: '',
            pelunasan: '',
            nama_marketing: '',
    ...
    { cell: 'E22', label: 'Nomor HP', type: 'text', key: 'nomor_hp' },
    { cell: 'E23', label: 'Instansi', type: 'select', key: 'instansi', optionsKey: 'instansi' },
    { cell: 'E24', label: 'Gaji Pensiun', type: 'integer', key: 'gaji_pensiun' },
    { cell: 'E25', label: 'Angsuran Lainnya', type: 'integer', key: 'angsuran_lainnya' },
    { cell: 'E26', label: 'Sisa Gaji saat pengajuan', type: 'output', key: 'sisa_gaji_saat_pengajuan', format: 'currency' },
    { cell: 'E27', label: 'Tenor Max', type: 'output', key: 'tenor_max', format: 'months' },
    { cell: 'E28', label: 'Plafond Max', type: 'output', key: 'plafond_max', format: 'currency' },
    { cell: 'E29', label: 'Tenor', type: 'integer', key: 'tenor' },
    ...
    { cell: 'E36', label: 'PROVISI', type: 'output', key: 'provisi', format: 'currency' },
    { cell: 'E37', label: 'ADMINISTRASI', type: 'output', key: 'administrasi', format: 'currency' },
    { cell: 'E38', label: 'ASURANSI', type: 'output', key: 'asuransi', format: 'currency' },
    { cell: 'E39', label: 'Extra Premi', type: 'output', key: 'extra_premi', format: 'currency' },
    { cell: 'E40', label: 'BLOKIR AMOUNT', type: 'output', key: 'amount_blokir_angsuran', format: 'currency' },
    { cell: 'E41', label: '', type: 'blank' },
    { cell: 'E42', label: 'TATA LAKSANA', type: 'output', key: 'tata_laksana', format: 'currency' },
    { cell: 'E43', label: 'PELUNASAN', type: 'integer', key: 'pelunasan' },
    { cell: 'E44', label: 'Nama Marketing', type: 'text', key: 'nama_marketing' },
    { cell: 'E45', label: 'Kode Area', type: 'select', key: 'kode_area', optionsKey: 'area', allowEmpty: true },
    { cell: 'E46', label: '', type: 'blank' },
    { cell: 'E47', label: 'USIA LUNAS', type: 'output', key: 'usia_lunas_text', format: 'text' },
    { cell: 'E48', label: 'TGL PERMOHONAN', type: 'output', key: 'tgl_permohonan', format: 'date' },
    { cell: 'E49', label: '', type: 'blank' },
    { cell: 'E50', label: 'TGL LUNAS', type: 'output', key: 'tgl_lunas', format: 'date' },
    { cell: 'E51', label: '', type: 'blank' },
    { cell: 'E52', label: 'TOTAL BIAYA', type: 'output', key: 'total_biaya', format: 'currency' },
    { cell: 'E53', label: 'SISA GAJI AKHIR', type: 'output', key: 'sisa_gaji_akhir', format: 'currency' },
    { cell: 'E54', label: 'TERIMA BERSIH', type: 'output', key: 'terima_bersih', format: 'currency' },
    { cell: 'E55', label: 'TERIMA BERSIH', type: 'output', key: 'terima_bersih', format: 'currency' },
],
        hasil: null,
        hasilDisplay: [],
        limits: null,
        ...
        applyInitialDefaults() {
            ...
            // Tetapkan nilai override secara pasti jika belum terisi dari edit data
            if (this.form.rate_percent_override === '' || this.form.rate_percent_override === null) {
                this.form.rate_percent_override = 16;
            }
            if (this.form.admin_angsuran_percent_override === '' || this.form.admin_angsuran_percent_override === null) {
                this.form.admin_angsuran_percent_override = 10;
            }
        },

        updateRateDefaults() {
            // Memastikan nilai override tidak tertimpa oleh konfigurasi produk
            if (this.form.rate_percent_override === '' || this.form.rate_percent_override === null || typeof this.form.rate_percent_override === 'undefined') {
                this.form.rate_percent_override = 16;
            }
            if (this.form.admin_angsuran_percent_override === '' || this.form.admin_angsuran_percent_override === null || typeof this.form.admin_angsuran_percent_override === 'undefined') {
                this.form.admin_angsuran_percent_override = 10;
            }
        },
        ...
        async simpan() {
            ...
            try {
                ...
                console.log('Payload dikirim ke store:', payload);
