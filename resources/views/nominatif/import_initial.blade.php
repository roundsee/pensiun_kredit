...
@section('content')
<div class="container py-3" x-data="initialNominatifForm()">
    <div class="row justify-content-center">
        <div class="col-xl-11">
            <div class="card mb-3">
                <div class="card-header fw-bold">Import Initial Nominatif</div>
                <div class="card-body">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            <label class="form-label">File Excel Initial</label>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <button class="btn btn-success" type="button" @click="save" :disabled="previewRows.length === 0">Simpan Initial</button>
            ...
            <div class="card">
                <div class="card-header fw-bold d-flex justify-content-between align-items-center">
                    <span>Preview Initial Nominatif</span>
...
@php
    $meta = [
        ...
        'banks' => $banks,
        'routes' => [
            'preview' => route('nominatif.initial.preview'),
            'store' => route('nominatif.initial.store'),
        ],
    ];
@endphp
<script type="application/json" id="nominatif-initial-meta">@json($meta)</script>

<script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3/dist/cdn.min.js"></script>
<script>
function initialNominatifForm() {
    const meta = JSON.parse(document.getElementById('nominatif-initial-meta')?.textContent || '{}');
    ...
    return {
        ...
        async preview() {
            ...
            if (!res.ok) {
                this.errorMessage = data.message || 'Preview initial nominatif gagal diproses.';
                return;
            }
        ...
        async save() {
            ...
            if (this.previewRows.length === 0) {
                this.errorMessage = 'Lakukan preview terlebih dahulu.';
                return;
            }
            ...
            if (!res.ok) {
                this.errorMessage = data.message || 'Gagal menyimpan initial nominatif.';
                return;
            }

            this.message = `Initial nominatif berhasil disimpan. ${data.rows_created} baris.`;
        },
    };
}
</script>
