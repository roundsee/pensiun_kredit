...
<div class="page">
    ...
    <ol>
        ...
        <li>Harap dilakukan pemblokiran dana new/top up pada rekening debitur sesuai data terlampir.</li>
        <li>Harap dilakukan pemindahbukuan dana new/top up dari rekening KSP Nata Buana ke rekening debitur dengan nomor rekening {{ $rekening_penerima }}.</li>
    </ol>
